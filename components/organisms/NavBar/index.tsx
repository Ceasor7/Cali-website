        ...
        <Container>
          ...
          >
            <div className="flex flex-col lg:flex-row w-full place-content-between lg:place-items-center">
              ...
              >
                <NavLink href="#description" value="Description" canActive={true} />
                <NavLink
                  href="#vision"
                  value="Vision"
                  canActive={true}
                ...
                <NavLink href="#team" value="Our Team" canActive={true} />
                <NavLink href="#program" value="Programs" canActive={true} />
              </div>
              <div
